...
<main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
        ...
        <!-- CTA -->
        <form class="space-y-6" action="{{ route('admin.ubahSiswa') }}" method="POST" enctype="multipart/form-data">
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="mb-6">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">NIS
                    </label>
                    <input type="text" id="id" name="id" value="{{$siswa->id}}" hidden>
                    <input type="text" id="nis" name="nis" required value="{{$siswa->nis}}"
                ...
                <div class="mb-6">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
                        ...
                        <select name="kelas_id" id="kelas_id"
                            ...
                            <option value="{{$siswa->kelas_id}}" selected>{{$siswa->hasKelas->nama}}</option>
